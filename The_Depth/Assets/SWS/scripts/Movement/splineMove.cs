...
namespace SWS
{
    ...
    public class splineMove : MonoBehaviour
    {
        ...
        {
            none, //disabled
            to2DTopDown, //allows for full turns as seen in top-down apps
            to2DSideScroll, //always tries to keep the object face-up
            to3D //orient to path rotation in 3D space
        }
        public OrientToPathType orientToPath = OrientToPathType.none;
        ...
        /// <summary>
        public Holoville.HOTween.Axis lockAxis = Holoville.HOTween.Axis.None;
